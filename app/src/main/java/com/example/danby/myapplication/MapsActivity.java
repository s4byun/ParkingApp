...
public class MapsActivity extends FragmentActivity implements
    ...
    final int LOGIN_ACTIVITY_REQUEST_CODE = 0;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == LOGIN_ACTIVITY_REQUEST_CODE) {
            if (resultCode == AppConfig.FB_LOGIN_RETURN_CODE_SUCCESS) {
                Log.i("fb_login", "MapsActivity received FB_LOGIN_RETURN_CODE_SUCCESS");
            } else if (resultCode == AppConfig.FB_LOGIN_RETURN_CODE_FAIL) {
                Log.e("fb_login", "MapsActivity received FB_LOGIN_RETURN_CODE_FAIL");
            }
        }
    }
